  ...
  <div class="bg-gray-900 text-gray-100 min-h-screen">
    ...
    >
      ...
      <div class="hidden md:flex md:flex-col p-1 border-b border-gray-700">
        <h1
          v-if="currentUser"
          class="text-xl font-bold text-indigo-600 font-baloo"
        >
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="relative">
          <button
            class="p-2 rounded-md text-gray-400 hover:text-white hover:bg-blue-700 focus:outline-none"
    ...
    <div class="flex pt-16 h-screen">
      <!-- Desktop Sidebar -->
      <aside
        class="hidden md:w-64 md:bg-gray-800 border-r border-gray-700 md:flex md:flex-col"
      >
        <!-- Main nav content -->
        <nav class="flex-1 p-4 space-y-2">
          <router-link
            ...
            :class="{ 'bg-gray-900': $route.path === '/u/dashboard' }"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
          ...
          <router-link
            to="/u/exam_schedule"
            class="flex items-center space-x-2 px-3 py-2 rounded text-gray-300 hover:bg-gray-700"
            :class="{ 'bg-gray-900': $route.path === '/u/exam_schedule' }"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
          ...
          <router-link
            to="/u/rooms"
            class="flex items-center space-x-2 px-3 py-2 rounded text-gray-300 hover:bg-gray-700"
            :class="{ 'bg-gray-900': $route.path === '/u/rooms' }"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
          ...
          <router-link
            ...
            class="flex items-center space-x-2 px-3 py-2 rounded text-gray-300 hover:bg-gray-700"
            :class="{
              'bg-gray-900': $route.path === '/u/invigilators',
            }"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <router-link
            ...
            class="flex items-center space-x-2 px-3 py-2 rounded text-gray-300 hover:bg-gray-700"
            :class="{
              'bg-gray-900': $route.path === '/u/course_modules',
            }"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <router-link
            ...
            to="/u/manage_institutions"
            class="flex items-center space-x-2 px-3 py-2 rounded text-gray-300 hover:bg-gray-700"
            :class="{ 'bg-gray-900': $route.path === '/u/manage_institutions' }"
          >
          ...
          <router-link
            to="/u/general_settings"
            class="flex items-center space-x-2 px-3 py-2 rounded text-gray-300 hover:bg-gray-700"
            :class="{ 'bg-gray-900': $route.path === '/u/general_settings' }"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
        ...
        <div
          class="item-bottom flex flex-col p-4 mt-auto border-t border-gray-600"
        >
      ...
      >
        <nav class="flex-1 p-4 space-y-2">
          ...
          <router-link
            to="/schedule_exams"
            class="flex items-center space-x-2 px-3 py-2 rounded text-gray-300 hover:bg-gray-700"
            :class="{ 'bg-gray-900': $route.path === '/u/schedule_exams' }"
            @click="mobileMenuOpen = false"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <router-link
            to="/invigilators"
            class="flex items-center space-x-2 px-3 py-2 rounded text-gray-300 hover:bg-gray-700"
            :class="{ 'bg-gray-900': $route.path === '/u/invigilators' }"
            @click="mobileMenuOpen = false"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <router-link
            to="/course_modules"
            class="flex items-center space-x-2 px-3 py-2 rounded text-gray-300 hover:bg-gray-700"
            :class="{ 'bg-gray-900': $route.path === '/u/course_modules' }"
            @click="mobileMenuOpen = false"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <main class="w-full flex-1 overflow-y-auto p-6 bg-gray-900">
        <div
          v-if="currentUser"
          class="w-full flex-1 max-h-[90vh] container mx-auto px-4 py-8"
        >
...
export default {
  ...
  mounted() {
    ...
    if (storedUser && token) {
      ...
      console.warn("User access is limited to unauthenticated pages only.");
      this.$router.push("/users/log_in");
    }
  },
  methods: {
