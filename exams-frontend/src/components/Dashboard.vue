            ...
            <div class="lg:col-span-2 bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-700">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex space-x-2">
                        <button
                            class="px-3 py-1 text-xs rounded-lg bg-gray-700 text-gray-300 hover:bg-gray-600">Day</button>
                        <button class="px-3 py-1 text-xs rounded-lg bg-indigo-600 text-white">Week</button>
                        <button
                            class="px-3 py-1 text-xs rounded-lg bg-gray-700 text-gray-300 hover:bg-gray-600">Month</button>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center">
                    <div class="relative mb-2">
                        <img src="https://randomuser.me/api/portraits/women/68.jpg"
                            class="w-12 h-12 rounded-full border-2 border-gray-700">
                        <span
                            class="absolute bottom-0 right-0 w-3 h-3 bg-gray-500 rounded-full border-2 border-gray-800"></span>
                    </div>
