  ...
  computed: {
    componentForRole() {
      ...
      switch (this.currentUser?.role) {
        case "admin":
          return defineAsyncComponent(() => import("./Admin.vue"));
        case "staff":
          return defineAsyncComponent(() => import("./Staff.vue"));
        case "student":
          return defineAsyncComponent(() => import("./Student.vue"));
        case "university":
          return defineAsyncComponent(() => import("./Institution.vue"));
        default:
          return null;
      }
    },
