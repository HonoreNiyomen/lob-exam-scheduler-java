<template>
    <div class="min-h-auto flex items-center justify-center bg-gray-900 px-4 py-12 w-full">
                ...
                <form @submit.prevent="handleLogin" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input id="remember_me" v-model="form.rememberMe" type="checkbox"
                        ...
                        <div class="text-sm">
                            <RouterLink to="/users/reset_password"
